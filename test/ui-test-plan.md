...
- Build command (PowerShell):
  ...
  ```powershell
  javac -d out src/main/java/bond/Bond.java src/main/java/bond/Task.java src/main/java/bond/Todo.java src/main/java/bond/Deadline.java src/main/java/bond/Event.java
  ```
